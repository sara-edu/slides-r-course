...
| Markdown Syntax                                              | Output                                                                                                 |
+==============================================================+========================================================================================================+
| ``` markdown                                                 | ![Rose](rose.jpg)                                                                                      |
| ![Rose](rose.jpg)                                            |                                                                                                        |
| ```                                                          |                                                                                                        |
+--------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+
| ``` markdown                                                 | [![Rose](rose.jpg)](https://quarto.org)                                                                |
| [![Rose](rose.jpg)](https://quarto.org)                      |                                                                                                        |
| ```                                                          |                                                                                                        |
+--------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+
| ``` markdown                                                 | [![Rose](rose.jpg)](https://quarto.org "The Rose")                                                     |
| [![Rose](rose.jpg)](https://quarto.org "The Rose")           |                                                                                                        |
| ```                                                          |                                                                                                        |
+--------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+
| ``` markdown                                                 | ![Rose](rose.jpg){fig-alt="A rose with dew drops."}                                                    |
| ![Rose](rose.jpg){fig-alt="A rose with dew drops."}          |                                                                                                        |
| ```                                                          |                                                                                                        |
+--------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+
...
Use `$` delimiters for inline math. For example:
...
Use `$$` delimiters for display math. For example:
...
#  {#sec-wrangle background-image="https://images.unsplash.com/photo-1586864143550-e78342051c9c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" background-size="cover"}
...
<br>
<br>
[DATA <br> WRANGLING]{.r-fit-text .theme-tech .centering}
:::
:::
