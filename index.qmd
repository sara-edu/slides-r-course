...
[This is our [actual]{.theme-red} work look.]{.r-fit-text}
...
## Types of Data Roles {.centering}

![](images/career.jpg){fig-align='center' width="60%"}

::: aside
[Source: Alex Wang](https://www.linkedin.com/feed/update/urn:li:activity:7142645513215950850/)
:::
...
Background image by [Andy Hermawan](https://unsplash.com/@kolamdigital)
...
# {transition="zoom" transition-speed="slow" .center}
...
"It includes a console, syntax-highlighting editor that supports direct code execution, and tools for plotting, history, debugging, and workspace management." [Source: posit](https://posit.co/products/open-source/rstudio/)
...
::: aside
<br>Source: [Metacran](https://www.r-pkg.org/)
:::
...
# [PUBLISH USING<br>QUARTO]{.r-fit-text} {#sec-publish background-image="https://images.unsplash.com/photo-1606636660488-16a8646f012c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" background-size="cover"}
...
::: {.column width="20%"}
<br> <br> [{{< fa arrow-right-long >}}]{.r-fit-text .theme-gray}
:::
...
## When you render the quarto document
...
::: aside
Source: [R for Data Science, 2e](https://r4ds.hadley.nz/quarto#sec-caching)
:::


## Source Editor & Visual Editor {.center}
...
[Markdown Basics:<br>TEXT]{.r-fit-text .rainbow-yellow}
...
[This text color becomes light blue color.]{.theme-red}
