...
R package name `palmerpenguins` & dataset name is `penguins` more information [here](https://allisonhorst.github.io/palmerpenguins/).
...
::: {.column width="25%"}
![](https://allisonhorst.github.io/palmerpenguins/reference/figures/palmerpenguins.png)
:::
